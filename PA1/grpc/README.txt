...
- pip install grcio grpcio-tools

Step 2:
From the current directory -
Run the server:
Usage: python grpc_server.py server-IP-address 
Example:
- python grpc_server.py 127.0.0.1

Step 3:
Change the file_size variable w.r.t the size of the file being transfered.

To run the client:
Usage: python grpc_client.py server-IP-address filename no-of-transfers
Example:
- python grpc_client.py 127.0.0.1 A_10MB 1000
