...
class H2Protocol(asyncio.Protocol):
    ...
    def request_received(self, headers: List[Tuple[str, str]], stream_id: int):
        ...
        file = open(path,'r')
        # data = file.read()
        data = io.BytesIO(bytes(file.read(),'utf-8'))
        # print("Length of data ",len(data))
        request_data = RequestData(headers, data)
        print("\nType of request ",type(request_data))
...
coro = loop.create_server(H2Protocol, '10.152.56.193', 8080)
